...
type PacingScheduleFieldsProps = {
  settings: Settings;
  setSettings: Dispatch<SetStateAction<Settings>>;
  intervalSelectValue: string;
};

/** Start / end / interval grid shared by posture pacing and hydration daily intention. */
export function PacingScheduleFields({
  settings,
  setSettings,
  intervalSelectValue,
}: PacingScheduleFieldsProps) {
  return (
